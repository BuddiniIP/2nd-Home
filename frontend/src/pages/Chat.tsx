    ...
    <div className="pb-24 px-4 sm:px-6 bg-white min-h-screen">
      <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-display font-bold text-black tracking-tight">Messages</h1>
        </div>
        ...
        <div className="h-[calc(100vh-280px)] min-h-[400px] sm:h-[600px]">
          ...
          <div className="sm:hidden h-full">
            {!showSidebar || !activeConv ? (
              <div className="h-full bg-white rounded-[2.5rem] shadow-sm border border-gray-50 overflow-hidden flex flex-col">
              ...
              <div className="h-full bg-white rounded-[2.5rem] shadow-sm border border-gray-50 flex flex-col overflow-hidden">
                <div className="p-4 border-b border-gray-50 flex items-center gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-bold truncate">{otherParticipant(activeConv).firstName} {otherParticipant(activeConv).lastName}</p>
                  ...
                  {messages.length === 0 ? (
                    ...
                    return (
                      <div key={msg._id} className={`flex ${isMine ? 'justify-end' : 'justify-start'}`}>
                        <div className={`max-w-[85%] sm:max-w-[70%] p-3 sm:p-4 rounded-2xl text-sm leading-relaxed ${isMine ? 'bg-black text-white rounded-br-md' : 'bg-gray-100 text-black rounded-bl-md'}`}>
                          <p>{msg.content}</p>
